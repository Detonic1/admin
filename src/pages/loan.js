...
const loan =() =>{
              ...
              {filteredLoans.length > 0 ? (
                filteredLoans.map((loan) => {
                  ...
                  const progressPercentage =
                    (loan.amountPaid / loan.amount) * 100;
                    ...
                    <tr key={loan.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-xs text-gray-500 mt-1">
                          {formatCurrency(loan.amountPaid)} of{" "}
                          {formatCurrency(loan.amount)} (
  ...
  const renderStatementsView = () => {
    ...
    const progressPercentage =
      (selectedLoan.amountPaid / selectedLoan.amount) * 100;
            ...
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-lg font-medium">
                  Statement for Loan #{selectedLoan.id}
                </h3>
            ...
            <div className="p-6 md:w-1/3 border-r">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {new Date(selectedLoan.issueDate).toLocaleDateString()}
                  </span>
                </div>
                <div className="flex justify-between">
