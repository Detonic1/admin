    ...
    <DashboardLayout>
      <div className="form-a-container">
        ...
        <div className="form-header">
          ...
          <div className="status-badge" data-status={formData.status.toLowerCase()}>
            {formData.status}
          </div>
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            <div className="form-row">
              ...
              <div className="form-value">{formData.userId}_{formData.trackingId}</div>
            </div>
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div className="form-row">
              ...
              <div className="form-value">{formData.userId} - {formData.amount}</div>
            </div>
        ...
        {formData.requestedDocuments && formData.requestedDocuments.length > 0 && (
          <div className="form-section">
                ...
                <div key={index} className="form-row">
                  ...
                  <div className="form-value">
                    <div className="requested-doc-info">
                      <span className="requested-doc-status" data-status={doc.status.toLowerCase().replace(/\s+/g, '-')}>
                        {doc.status}
                      </span>
          ...
          <div className="admin-note-section">
            ...
            <div className="admin-buttons">
              <div className="admin-primary-buttons">
                <button className="send-button" onClick={handleSendDocumentRequest}>
                  <i className="fas fa-paper-plane"></i> Send
                </button>
                <button className="request-doc-button" onClick={handleRequestDocument}>
